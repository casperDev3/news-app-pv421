...
const Onboarding2Screen = () => {
    ...
    return (
        <View style={s.container}>
            ...
            <Image
                style={s.image}
                source={{uri: "https://picsum.photos/seed/topics2/800/1000"}}
            />
            ...
            <View style={s.card}>
                ...
                <Text style={s.title}>Select Your Topics</Text>
                <Text style={s.desc}>
                    Choose topics that interest you most. We'll curate a personalized news feed just for you.
                </Text>
